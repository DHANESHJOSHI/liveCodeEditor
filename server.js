...
// Middleware to intercept requests and convert HTTPS to HTTP
...
app.get("/", (req, res) => {
    res.send('you are authorized to use this app <a href="https://live-code-techwithjoshi.vercel.app/">Go Back To Code Editor</a>');
});
